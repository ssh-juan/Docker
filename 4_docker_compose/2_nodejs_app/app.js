...
const version = process.env.VERSION //Lendo versão do ambiente (variável de ambiente)
...
server.listen(port, hostname, () => {                               //Iniciando o servidor e ouvindo na porta e hostname definidos
    console.log(`Server running at http://${hostname}:${port}/ and version ${version}`);   //Logando mensagem de sucesso no console
});
